...
$form = [
    ...
    'course_id' => $isEdit ? (string) $module['course_id'] : '',
...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    if ($courseId === null || get_course($courseId) === null) {
    ...
    if ($courseId !== null && $form['module_code'] !== '' && module_code_exists($courseId, $form['module_code'], $moduleId)) {
        $errors[] = 'That module code already exists in this course.';
    }
...
<div class="mb-3">
    <a href="<?= e(app_url($academicRoutePrefix . '/modules/index.php')) ?>" class="btn btn-outline-secondary btn-sm">&larr; Back to Modules</a>
</div>
    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="module_code" name="module_code" value="<?= e($form['module_code']) ?>" required>
            </div>
            <div class="col-md-4">
                <label for="module_name" class="form-label">Module Name</label>
                <input type="text" class="form-control" id="module_name" name="module_name" value="<?= e($form['module_name']) ?>" required>
            </div>
            <div class="col-md-4">
