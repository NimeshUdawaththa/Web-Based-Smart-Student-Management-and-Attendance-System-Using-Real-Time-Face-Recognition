...
<div class="card shadow-sm mb-4">
    <div class="card-header bg-white">
        <h2 class="h5 mb-0">Final result</h2>
    </div>
    <div class="card-body">
        <dl class="row mb-0">
            ...
            <dd class="col-sm-9">
                <?= e($record['module_code'] . ' · ' . $record['session_date']) ?>
                · <?= e(format_time_display($record['scheduled_start']) . '–' . format_time_display($record['scheduled_end'])) ?>
                · <?= e((string) $record['batch_name']) ?>
            </dd>
...
<div class="card shadow-sm">
    ...
    <div class="card-body py-2">
        <p class="small text-muted mb-0">Face images and embeddings are not stored here.</p>
    </div>
    <div class="table-responsive">
        <table class="table table-sm mb-0 align-middle">
            ...
            <tbody>
                <?php if ($events === []): ?>
                    <tr><td colspan="4" class="text-center text-muted py-3">No IN/OUT events for this student in this session.</td></tr>
                <?php else: ?>
