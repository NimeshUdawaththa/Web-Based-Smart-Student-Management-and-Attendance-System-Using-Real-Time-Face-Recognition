...
$cameraStatus = camera_public_status();
$cameraOnline = strtoupper((string) ($cameraStatus['status'] ?? '')) === 'ONLINE' ? 1 : 0;
...
<section class="app-dashboard-welcome">
    ...
    <p class="app-dashboard-welcome__meta mb-0">
        Admin overview — manage people, academic structure, and teaching operations.
    </p>
</section>
    ...
    <div class="row g-3">
        ...
        <div class="col-6 col-lg-3">
            <div class="metric-card">
                <div class="metric-card__row">
                    <div>
                        <span class="metric-card__label">Camera Online</span>
                        <span class="metric-card__value"><?= (int) $cameraOnline ?></span>
                        <span class="metric-card__helper"><?= e((string) ($cameraStatus['status'] ?? 'OFFLINE')) ?></span>
                    </div>
                    <span class="metric-card__icon" aria-hidden="true"><i class="bi bi-camera-video"></i></span>
                </div>
            </div>
        </div>
    </div>
...
<section class="app-dashboard-section">
    <h2 class="app-dashboard-section__title">Teaching</h2>
    <div class="row g-3">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <p class="text-muted small">Oversee dated lecture occurrences.</p>
                    <a href="<?= e(app_url('admin/sessions/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <a href="<?= e(app_url('admin/camera.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="app-dashboard-section">
    <h2 class="app-dashboard-section__title">People &amp; academic structure</h2>
    <div class="row g-3">
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    <span class="app-action-card__icon" aria-hidden="true"><i class="bi bi-people"></i></span>
                    <h3 class="h6 mb-1">User Management</h3>
                    <p class="text-muted small">Create, edit, and activate system login accounts.</p>
                    <a href="<?= e(app_url('admin/users/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <p class="text-muted small">Register students and manage academic records.</p>
                    <a href="<?= e(app_url('admin/students/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <h3 class="h6 mb-1">Lecturer Management</h3>
                    <p class="text-muted small">Maintain lecturer profiles and linked accounts.</p>
                    <a href="<?= e(app_url('admin/lecturers/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <a href="<?= e(app_url('admin/modules/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <a href="<?= e(app_url('admin/courses/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <a href="<?= e(app_url('admin/batches/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <p class="text-muted small">System-wide finalized attendance reports and CSV export.</p>
                    <a href="<?= e(app_url('admin/attendance/reports.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    <span class="app-action-card__icon" aria-hidden="true"><i class="bi bi-person-workspace"></i></span>
                    <h3 class="h6 mb-1">Academic Staff</h3>
                    <p class="text-muted small">Manage academic staff records and account status.</p>
                    <a href="<?= e(app_url('admin/academic-staff/index.php')) ?>" class="btn btn-outline-primary btn-sm">Open</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <a href="<?= e(app_url('admin/announcements/index.php')) ?>" class="btn btn-outline-primary btn-sm">Manage</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card app-action-card">
                <div class="card-body">
                    ...
                    <a href="<?= e(app_url('admin/events/index.php')) ?>" class="btn btn-outline-primary btn-sm">Manage</a>
                </div>
            </div>
        </div>
    </div>
