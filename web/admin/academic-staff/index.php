...
<div class="d-flex justify-content-between align-items-center mb-4">
    <p class="text-muted mb-0">Manage academic staff profiles and linked accounts.</p>
...
<div class="card shadow-sm">
    <div class="table-responsive">
        <table class="table table-hover mb-0 align-middle">
            ...
            <tbody>
                <?php if ($staffMembers === []): ?>
                    <tr><td colspan="6" class="text-center text-muted py-4">No academic staff found.</td></tr>
                <?php else: ?>
